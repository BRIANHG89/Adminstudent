...
<html lang = "eng">
	<head>
		...
		<link href="css/quizzer.css" type="text/css" rel="stylesheet">
	</head>
	<body style = "background-color:#d3d3d3;">
		...
		<div class = "container-fluid">
			...
			<li><a style = "font-size:18px; border-bottom:1px solid #d3d3d3;" href = "activities.php"><i class = "glyphicon glyphicon-book"></i> Activities</a></li>
			...
			<li><a style = "font-size:18px; border-bottom:1px solid #d3d3d3;" href = ""><i class = "glyphicon glyphicon-th"></i> Books</a>
			<ul style = "list-style-type:none;">
		    ...
		    <li><a href = "activities.php" style = "font-size:15px;"><i class = "glyphicon glyphicon-random"></i> Activities</a></li>
				</ul>
			</li>
